...
export default async function AdminCoachApplicationsPage() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-semibold">Guru applications</h1>
      <p className="mt-1 text-sm text-black/60 dark:text-white/60">
        Applications submitted through the public &quot;Become a Guru&quot; page.
      </p>
      ...
      <Card className="mt-6 p-0">
        <div className="divide-y divide-black/5 dark:divide-white/5">
          ...
          {applications.length === 0 && (
            <p className="p-6 text-sm text-black/50 dark:text-white/50">No guru applications yet.</p>
          )}
        </div>
      </Card>
    </div>
